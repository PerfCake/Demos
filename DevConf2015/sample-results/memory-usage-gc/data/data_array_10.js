var data_array_10 = [ ['Time', 'Throughput (GC=true)', 'Throughput (GC=false)' ] ];

var columns = [1, 1]; // 2, 2
var limiter = [vertx_put_throughput20150206170807.length, vertx_put_throughput20150206180417.length]; // arr.length, arrr.length
var data = [vertx_put_throughput20150206170807, vertx_put_throughput20150206180417];
var len = data.length;
