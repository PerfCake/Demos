FEL ČVUT B6B36TS1 Live coding session
=====================================
...
2. Download PerfCake 7.4 distribution from www.perfcake.org and unzip it into any location.
...
3. In the directory where did you check out the demo sources, go to ```FelCvut2017/part2/exercise1/finished```
 ...
 * `$PERFCAKE_HOME` - location with unzipped PerfCake 7.4 (e.g. `/home/user/perfcake-7.4`)
